...
<body>
	<div class="container" align="center">	
		<div class="wrap-login100 p-t-50 p-b-90">
			<form class="login100-form validate-form flex-sb flex-w" method="post" action="${pageContext.request.contextPath}/DeletePostServlet">
				<input type="hidden" value="${postNo}" name="postNo">
				<span class="login100-form-title p-b-51">Delete Post Page</span>
				<div class="wrap-input100 validate-input m-b-16" data-validate="Password is required">
					<input class="input100" type="text" name="deletetext" readonly="readonly" placeholder="정말 삭제하시겠습니까?">
				</div>
				<div class="container-login100-form-btn m-t-17">
					<button type="submit" style="background-color: #6c757d;" class="login100-form-btn">yes</button>
					<a href="${pageContext.request.contextPath}/SelectPostOneServlet?postNo=${postNo}" style="background-color: #6c757d;" class="login100-form-btn">no</a>
				</div>
			</form>
		</div>
	</div>
