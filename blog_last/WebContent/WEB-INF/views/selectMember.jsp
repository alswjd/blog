...
<body>
	...
	<div class="container" align="center">
		<div class="wrap-login100 p-t-50 p-b-90">
			<form class="login100-form validate-form flex-sb flex-w"  method="post" action="${pageContext.request.contextPath}/SelectMemberServlet">
				<span class="login100-form-title p-b-51">My page</span>
				<div class="wrap-input100 validate-input m-b-16" data-validate="Username is required">
					<input class="input100" type="text" name="username" placeholder=" ${member.memberId}" readonly="readonly">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input m-b-16" data-validate="Password is required">
					<input class="input100" type="password" name="pass" placeholder=" ${member.memberLevel}" readonly="readonly">
					<span class="focus-input100"></span>
				</div>
				<div class="container-login100-form-btn m-t-17">
					<a href="${pageContext.request.contextPath}/DeleteMemberServlet" style="background-color: #6c757d;" class="login100-form-btn">회원탈퇴</a>
				</div>
			</form>
		</div>
	</div>
